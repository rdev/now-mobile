...
export const themes = {
	light: {
		background: 'white',
		text: platformBlackColor,
		dimmedText: '#B5B5B5',
		lightText: '#848484',
		redText: '#ec6262',
		whatsNewText: '#CACACA',
		deploymentErrorText: '#D74C58',
		border: '#EAEAEA',
		modeSwitcherBorder: '#DEDEDE',
		input: '#D3D3D3',
		authCodeBackground: '#f7f7f7',
		dropdownBackground: 'white',
		monoBackground: '#f5f5f5',
	...
	dark: {
		...
		deploymentErrorText: '#D74C58',
		border: '#353535',
		modeSwitcherBorder: '#555555',
		input: '#7A7A7A',
		authCodeBackground: '#202020',
		dropdownBackground: '#151515',
		monoBackground: '#202020',
		monoGreenText: '#12DDA0',
		monoYellowText: '#E2B538',
